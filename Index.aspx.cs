...
public partial class Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string sqls = "SELECT * FROM [dbo].[HOUSE]";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (xian)
        {
            string sqls = "SELECT * FROM [dbo].[HOUSE] WHERE City = 'xian' and Price >= " + Price1 + " and Price <= " + Price2;
        ...
        if (chengdu)
        {
            string sqls = "SELECT * FROM [dbo].[house] WHERE City = 'chengdu'and Price >= " + Price1 + " and Price <= " + Price2; ;
            DataTable dt1 = DB.ExecuteQuery(sqls);
            if (dt1 != null)
            {
                dt = dt1.Clone();
        ...
        if (chongqing)
        {
            string sqls = "SELECT * FROM [dbo].[house] WHERE City = 'chongqing' and Price >= " + Price1 + " and Price <= " + Price2;
            DataTable dt1 = DB.ExecuteQuery(sqls);
            if (dt1 != null)
            {
                dt = dt1.Clone();
        ...
        {
            string sqls = "SELECT * FROM [dbo].[house] WHERE and Price >= " + Price1 + " and Price <= " + Price2;
            DataTable dt1 = DB.ExecuteQuery(sqls);
            if (dt1 != null)
            {
                dt = dt1.Clone();
